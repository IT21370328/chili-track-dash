      ...
      >
        ...
        <div className="relative flex-1 flex flex-col">
          ...
          <div className="relative flex-1 flex flex-col px-6 py-4 space-y-3" style={{ lineHeight: 1 }}>
                ...
                <table className="w-full border-collapse text-xs table-fixed border border-gray-300" style={{ lineHeight: 1 }}>
                  ...
                  <tbody>
                    <tr className="text-center" style={{ lineHeight: 1 }}>
                      <td className="p-3 bg-[#C3E4FF] border border-gray-300">Date of Production</td>
                      <td className="p-3 bg-[#C3E4FF] border border-gray-300">{formatDate(transaction.date || "")}</td>
                      <td className="p-3 bg-[#C3E4FF] border border-gray-300">Date of Expiry</td>
                      <td className="p-3 bg-[#C3E4FF] border border-gray-300">{formatDate(transaction.dateOfExpiration || "")}</td>
                    </tr>
                    <tr className="text-center" style={{ lineHeight: 1 }}>
                      <td className="p-3 bg-[#C3E4FF] border border-gray-300">Batch Code/s</td>
                      <td className="p-3 bg-[#C3E4FF] border border-gray-300">{transaction.batchCode}</td>
                      <td className="p-3 bg-[#C3E4FF] border border-gray-300">No. of Boxes</td>
                      <td className="p-3 bg-[#C3E4FF] border border-gray-300">{transaction.numberOfBoxes}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            {/* Analysis Table */}
            <div className="flex flex-col flex-1 -mb-1" style={{ lineHeight: 1 }}>
              ...
              <div className="overflow-hidden">
                <table className="w-full border-collapse text-xs bg-transparent border border-gray-300" style={{ lineHeight: 1 }}>
                  ...
                  <tbody>
                    {/* Physical Section */}
                    <tr>
                      <td colSpan={5} className="bg-[#C3E4FF] font-bold p-3 border border-gray-300">Physical</td>
                    </tr>
                    <tr>
                      <td className="p-3 border border-gray-300">Appearance</td>
                      <td className="p-3 border border-gray-300">3</td>
                      <td className="p-3 border border-gray-300">Match with specifications</td>
                    ...
                    <tr>
                      ...
                      <td className="p-3 border border-gray-300">3</td>
                      <td className="p-3 border border-gray-300">Match with specifications</td>
                      <td className="p-3 border border-gray-300">Characteristic extra pungent flavor</td>
                    ...
                    <tr>
                      ...
                      <td className="p-3 border border-gray-300">3</td>
                      <td className="p-3 border border-gray-300">Match with specifications</td>
                      <td className="p-3 border border-gray-300">Mixed chili and fruity odor</td>
                      <td className="p-3 border border-gray-300">Sensory</td>
                    </tr>
                    <tr>
            ...
            <div className="text-xs -mt-1" style={{ lineHeight: 1 }}>
              ...
              <p className="m-0 p-0">
                We hereby certify that the aforementioned product meets the most recent Ma's De Cozta
                (Pvt) Ltd. product specifications and was produced in accordance with GMP principles.
              </p>
            </div>

            {/* Signatures */}
            <div className="pt-4 flex justify-between text-center text-xs" style={{ lineHeight: 1 }}>
              <div className="w-1/4 border-t border-gray-300 pt-2">Quality Assurance Manager</div>
              <div className="w-1/4 border-t border-gray-300 pt-2">Production Manager</div>
              <div className="w-1/4 border-t border-gray-300 pt-2">Date</div>
            </div>
          </div>
        </div>
